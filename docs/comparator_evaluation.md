...
`recompute/results/comparator_type1.csv` into `comparator_evaluation_tables.md`;
...
`m100` — and `m100` is the outcome-blind rule that
`permutation_null_specification.md` already argues is incoherent, since it
admits NHIS 2024 age levels of n=286 with
...
- `recompute/results/comparators/<cohort>.json` — per-partition diagnostics for
  every method
- `comparator_evaluation_tables.md` — every table, generated
